...
class templates
{
	...
	public function RegisterMail($login, $passw, $question, $answer, $name, $act_link, $ref_link)
	{
        ...
        return $this->GetTemplate('reg_template', $replace_list);
	}
	...
	public function RememberMail($ip, $servname, $accounts)
	{
        ...
        return $this->GetTemplate('rem_template', $replace_list);
	}
	...
	public function ResetPasswMail($ip, $login, $passw, $question, $answer, $servname)
	{
        ...
        return $this->GetTemplate('reset_template', $replace_list);
	}
	...
	public function ChangePasswMail($ip, $login, $passw, $servname)
	{
        ...
        return $this->GetTemplate('change_passw_template', $replace_list);
	}

	public function TestMail()
	{
		$replace_list = array();
        return $this->GetTemplate('test_mail_template', $replace_list);
	}
	...
	public function ResetIPMail($ip, $login, $servname)
	{
        ...
        return $this->GetTemplate('rem_ip_process_template', $replace_list);
	}
}