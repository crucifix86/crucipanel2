...
if ($cron_passw && $cron_passw != $cron_act_passw) die('Wrong passw');
if ($cron_act && $cron_passw == $cron_act_passw) {
	...
	switch ($cron_act) {
		...
		case 'update_user_info':			
			$postdata = array( 'op' => $cron_act,
			   'ip' => $_SERVER['REMOTE_ADDR'],
			   'ref_don_level_bonus_enabled' => $ref_don_level_bonus_enabled,
			   'ref_require_level' => $ref_require_level,
			   'ref_item_id' => $ref_item_id,
			   'ref_item_count' => $ref_item_count,
			   'ref_item_maxcount' => $ref_item_maxcount,
			   'ref_item_data' => $ref_item_data,
			   'ref_item_proctype' => $ref_item_proctype,
			   'ref_item_expire' => $ref_item_expire,
			   'ref_item_mask' => $ref_item_mask,
		...
		case 'make_skill_icons':
            ...
            if ($icons_type === 'Files') include 'makeicons_files.php'; else
...
?>	
			...
			<div class="row-fluid">
				<div class="box span12">
					...
					<div class="box-content" id="main_content_div">
						<?php
						...
						if (($cur_dost==2 && !$_SESSION['isadmin'])||($cur_dost==1 && !$_SESSION['isadmin'] && $_SESSION['rules_cnt']==0) || ($cur_dost==3 && !in_array($_SESSION['id'], $ext_users)) || ($cur_dost==4 && !in_array($_SESSION['id'], $log_read_ids))) {
							?>
						...
						<?php
							...
							switch ($op){
                                ...
                                case 'logs': include('pages/logs.php');
                                break;

                                case 'donate': include('pages/donate.php');
								break;

								case 'pvp': include('pages/pvp.php');
								break;
								...
								case 'lklogs1': include('pages/lklogs1.php');
								break;
