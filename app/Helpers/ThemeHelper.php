...
class ThemeHelper
{
    public static function getThemeVariables($theme = null)
    {
        if (!$theme) {
    ...
    {
        $vars = self::getThemeVariables($theme);
        
        return "
        :root {
            --body-bg: {$vars['body_bg']};
            ...
            --surface-color: {$vars['surface_color']};
            --border-color: {$vars['border_color']};
            --mystical-bg: {$vars['mystical_bg']};
            --particle-color: {$vars['particle_color']};
            --particle-shadow: {$vars['particle_shadow']};
            --dragon-color: {$vars['dragon_color']};
            --logo-gradient: {$vars['logo_gradient']};
            --button-gradient: {$vars['button_gradient']};
            --footer-bg: {$vars['footer_bg']};
        }
        ";
    }
}