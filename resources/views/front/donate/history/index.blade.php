        ...
        <div class="mx-auto rounded max-w-3xl xl:-mx-4">
            ...
            <ul id="tabs"
                ...
                @if( config('ipaymu.status') )
                    <li class="flex flex-1 justify-center px-4 py-2 font-semibold rounded-t "><a
                            href="#ipaymu">{{ __('donate.history.ipaymu') }}</a></li>
                @endif
            </ul>
                                    ...
                                    @foreach( $ipaymu->sortByDesc('created_at') as $ipay )
                                        <tr class="border-b border-gray-200 bg-gray-50 hover:bg-gray-100 dark:border-primary dark:bg-darker dark:hover:bg-primary-dark">
                                            ...
                                            <td class="py-3 px-6 text-left">
                                                <div class="flex items-center">
                                                    <span
                                                        class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full {{ $ipay->status == 'berhasil' ? 'text-green-800' : 'text-yellow-800' }} {{ $ipay->status == 'berhasil' ? 'bg-green-100' : 'bg-yellow-100' }}">{{ strtoupper($ipay->status) }}</span>
                                                </div>
                                            </td>
                                        </tr>
                                    @endforeach
