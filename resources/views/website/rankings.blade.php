    ...
    <div class="container">
        <div class="header">
            ...
            <div class="logo-container">
                ...
                <p class="tagline">Champions of the Realm</p>
            </div>
        </div>
        ...
        <nav class="nav-bar">
            <div class="nav-links">
                ...
                <a href="{{ route('app.shop.index') }}" class="nav-link">Shop</a>
                @endif
                ...
                <a href="{{ route('public.rankings') }}" class="nav-link active">Rankings</a>
                @endif
        ...
        @php
            ...
            $footerContent = $footerSettings ? $footerSettings->content : '<p class="footer-text">Legends are forged in battle</p>';
