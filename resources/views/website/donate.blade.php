...
<div class="content-section donate-section">
            ...
            <div class="donation-methods">
                ...
                <div class="no-methods">
                    <span class="no-methods-icon">💳</span>
                    <p class="no-methods-title">{{ __('site.donate.methods.no_methods') }}</p>
                    <p class="no-methods-text">{{ __('site.donate.methods.contact_admin') }}</p>
                </div>
                @endif
            </div>
            ...
            @else
            <div class="login-notice welcome-notice">
