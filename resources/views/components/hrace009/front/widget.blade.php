                ...
                <table id="gm_status" class="w-full table table-auto">
                    ...
                    @foreach( $gms as $gm )
                        <tr>
                            ...
                            <td class="p-2 text-left" data-discord-name="{{ $gm->truename }}"><span class="gm-username" style="font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif !important; text-transform: none !important; font-variant: normal !important; font-variant-caps: normal !important; display: inline-block;">{{ $gm->truename }}</span></td>
