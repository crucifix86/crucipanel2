...
Route::group(['middleware' => 'web'], static function () {
    ...
    /* Theme Assets - inside web middleware for session/auth access */
    Route::get('/theme/css', [App\Http\Controllers\ThemeAssetController::class, 'css'])->name('theme.css');
...
Route::group(['prefix' => 'admin', 'middleware' => ['auth', 'web', 'verified', 'admin']], static function () {
    ...
    Route::group(['prefix' => 'system'], static function () {
        ...
        Route::post('themes/{theme}/toggle-visibility', [
            'as' => 'admin.themes.toggle-visibility',
            'uses' => 'App\Http\Controllers\Admin\ThemeController@toggleVisibility'
        ]);
        Route::post('themes/{theme}/toggle-auth', [
            'as' => 'admin.themes.toggle-auth',
            'uses' => 'App\Http\Controllers\Admin\ThemeController@toggleAuthTheme'
        ]);
        Route::post('themes/{theme}/set-default', [
            'as' => 'admin.themes.set-default',
            'uses' => 'App\Http\Controllers\Admin\ThemeController@setAsDefault'
        ]);
        Route::post('themes/{theme}/clone', [
            'as' => 'admin.themes.clone',
            'uses' => 'App\Http\Controllers\Admin\ThemeController@clone'
        ]);
        Route::get('themes/{theme}/edit', [
            'as' => 'admin.themes.edit',
            'uses' => 'App\Http\Controllers\Admin\ThemeController@edit'
        ]);
        Route::put('themes/{theme}', [
            'as' => 'admin.themes.update',
            'uses' => 'App\Http\Controllers\Admin\ThemeController@update'
        ]);
        Route::get('themes/revert-to-safety', [
            'as' => 'admin.themes.revert-to-safety',
            'uses' => 'App\Http\Controllers\Admin\ThemeController@revertToSafety'
        ]);
        Route::post('themes/reset-all-users', [
            'as' => 'admin.themes.reset-all-users',
            'uses' => 'App\Http\Controllers\Admin\ThemeController@resetAllUsersToDefault'
        ]);
        Route::delete('themes/{theme}', [
            'as' => 'admin.themes.destroy',
            'uses' => 'App\Http\Controllers\Admin\ThemeController@destroy'
        ]);
